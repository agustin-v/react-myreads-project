...
This is the first project for Udacity's React Fundamentals course. The goal of this assignment is to develop a simple application using only React.
...
If you want to contribute please fork the repository and then request a PR.
